...
const Modal = ({ isOpen, handleClose, courseId, handleRegister }) => {
    return (
        <>
                ...
                <div className="relative p-4 w-full max-w-md max-h-full mx-auto top-5">
                    <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-100">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <h3 className="mb-5 font-medium text-lg">Do you want to register this course?</h3>
                            ...
                            <button value={courseId} onClick={(e) => { handleRegister(e), handleClose(e) }} type="button" className="px-3 py-3 rounded-md mr-10 font-semibold cursor-pointer bg-green-700 text-white hover:bg-green-600 hover:text-white">Yes, I do</button>
                        </div>
                    </div>
                </div>
            </div>
